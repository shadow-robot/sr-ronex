...
protected:
  // This will be used for the moment. If we have inputs and outputs that don't fit this digital and analog i/o array
  // model then we'll have to change it and probably move this extract and publish stage to the different CodDecod
  // children classes.
