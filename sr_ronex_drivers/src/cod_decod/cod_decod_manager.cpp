...
namespace sr_cod_decod
{
  ...
  CodDecodManager::CodDecodManager(ros_ethercat_mechanism_model::Robot *hw, EtherCAT_SlaveHandler *sh, int n_digital_outputs, int n_analog_outputs, int n_digital_inputs, int n_analog_inputs, int n_PWM_outputs)
