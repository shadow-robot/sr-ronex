...
namespace sr_cod_decod
{
  ...
  void CodDecod::construct(ros_ethercat_model::RobotState *hw, EtherCAT_SlaveHandler *sh, int n_digital_outputs, int n_analog_outputs, int n_digital_inputs, int n_analog_inputs, int n_PWM_outputs)
  {
    sh_ = sh;
    hw_ = hw;
  }
