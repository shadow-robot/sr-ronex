...
namespace ronex
{
  namespace mapping
  {
    ...
    {
      CommandToPWM::CommandToPWM(TiXmlElement* mapping_el, ros_ethercat_mechanism_model::Robot* robot)
      ...
      void CommandToPWM::propagateToRonex(std::vector<ros_ethercat_mechanism_model::JointState*>& js)
      {
        assert(js.size() == 1);
