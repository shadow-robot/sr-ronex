...
namespace ronex
{
  namespace mapping
  {
    ...
    {
      AnalogueToEffort::AnalogueToEffort(TiXmlElement* mapping_el, ros_ethercat_mechanism_model::Robot* robot)
      ...
      void AnalogueToEffort::propagateFromRonex(std::vector<ros_ethercat_mechanism_model::JointState*>& js)
      {
        assert(js.size() == 1);
