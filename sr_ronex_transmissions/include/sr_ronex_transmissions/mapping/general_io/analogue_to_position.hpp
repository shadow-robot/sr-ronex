  ...
  namespace mapping
  {
    namespace general_io
    {
      ...
      public:
        AnalogueToPosition()
         : RonexMapping() {};
        AnalogueToPosition(TiXmlElement* mapping_el, ros_ethercat_mechanism_model::Robot* robot);
         ...
         */
        virtual void propagateFromRonex(std::vector<ros_ethercat_mechanism_model::JointState*>& js);

        /**
         * This function is not doing anything as we're not propagating a command in this mapping.
         */
        virtual void propagateToRonex(std::vector<ros_ethercat_mechanism_model::JointState*>& js) {};
