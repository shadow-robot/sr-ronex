...
#define RONEX_COMMAND_02000008_COMMAND_TYPE_SET_REG_VAL         0x0002      //!< This is used to configure the single ended / differential inputs
#define RONEX_COMMAND_02000008_COMMAND_TYPE_WRITE_REGS          0x0003      //!< This is used to configure the single ended / differential inputs
#define RONEX_COMMAND_02000008_COMMAND_TYPE_GET_CONFIG_INFO     0x0004      //!< This requests a CONFIG_INFO_02000008 block from the node.
...
typedef struct
{
    ...
    union16     adc16[48];
}__attribute__((packed)) STATUS_DATA_02000008;
...
}__attribute__((packed)) CONFIG_INFO_02000008;

typedef struct
{
    int8u       address;
    int8u       values[3];
    int8u       padding[sizeof(STATUS_DATA_02000008) - (sizeof(int8u)*4)];
}__attribute__((packed)) REGISTER_FB_02000008;
...
typedef struct
{
    ...
    {                                                   // 
        ...
        REGISTER_FB_02000008  register_feedback;        //      - A check that the PSoC recieved our register write data
    }info_type;
