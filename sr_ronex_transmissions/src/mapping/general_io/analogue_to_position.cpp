...
namespace ronex
{
  namespace mapping
  {
    ...
    {
      AnalogueToPosition::AnalogueToPosition(TiXmlElement* mapping_el, ros_ethercat_mechanism_model::Robot* robot)
      ...
      void AnalogueToPosition::propagateFromRonex(std::vector<ros_ethercat_mechanism_model::JointState*>& js)
      {
        assert(js.size() == 1);
